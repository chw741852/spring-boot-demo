...
public class BaseService {
    ...
    public BaseService(ApplicationInfoManager applicationInfoManager, EurekaClient eurekaClient,
    ...
    public void start() {
        ...
        System.out.println("Simulating service initialization by sleep for 2 seconds...");
        try {
            Thread.sleep(2000);
        ...
        try {
            ...
            System.out.println("Client got connected... processing requrest from the client.");
            processRequest(s);
        } catch (IOException e) {
            e.printStackTrace();
        }

        System.out.println("Simulating service doing work by sleep for 10 senconds...");
        try {
    ...
    private void processRequest(final Socket s) {
        try {
            ...
            System.out.println("Sending the response to client: " + response);
